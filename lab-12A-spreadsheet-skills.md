# ปฏิบัติการที่ 12A - การจัดการข้อมูลตารางและการสร้างกราฟด้วย Google Sheets
...
| รายการ | รายละเอียด |
|---|---|
| ระยะเวลา | 3 ชั่วโมง (5 โมดูล M1-M5) |
| คะแนน | 20 คะแนน - ส่งงานภายในชั้นเรียน ไม่รับงานย้อนหลัง |
| รูปแบบงาน | งานเดี่ยว บน Student Workbook ที่แจกผ่าน Google Classroom |
| แพลตฟอร์ม | Google Sheets |
| ทักษะคอมพิวเตอร์ที่ต้องมีก่อน | ไม่ต้องมี - โมดูล M1 สอนตั้งแต่เริ่มต้น |
...
รุ่น F2        :   ปล่อยให้ F1 ผสมตัวเอง แล้วบันทึกลักษณะและน้ำหนักผลของต้น F2 ทุกต้น
```
...
| เวลา | โมดูล | แท็บ | ฟังก์ชันที่ได้ใช้ | คะแนน |
|---|---|---|---|---|
| 0:00-0:10 | เปิดคาบ + Pre-lab quiz | - | - | 2 |
| 0:10-0:40 | M1 พื้นฐานสเปรดชีตและสูตรแรก | 01_ฝึกพื้นฐาน | ชื่อเซลล์ · = · ช่วง : · การเติมสูตร · ตรึง $ · SUM | 2 |
| 0:40-1:15 | M2 ฟังก์ชันข้อความและการทำความสะอาด | 03_Clean | TRIM PROPER & LEFT MID LEN SUBSTITUTE COUNTIF IF AND | 5 |
| 1:15-1:25 | พัก |  |  |  |
| 1:25-2:00 | M3 สรุปข้อมูลด้วยสถิติพื้นฐาน | 04_Summary | COUNTA COUNT MIN MAX SUM AVERAGE ROUND | 4 |
...
| ฟังก์ชัน | ตัวอย่าง | ทำอะไร | โมดูล |
|---|---|---|---|
...
>
> ทำงานสะสมไปทีละโมดูล แล้วกด Turn in ก่อนออกจากห้อง

### โมดูล M1 - พื้นฐานสเปรดชีตและสูตรแรก (30 นาที, 2 คะแนน)
...
### โมดูล M2 - ฟังก์ชันข้อความและการทำความสะอาดข้อมูล (35 นาที, 5 คะแนน)
...
**M2.9** สร้างคอลัมน์น้ำหนักเฉพาะต้นที่ใช้ได้ ที่เหลือปล่อยว่างไว้ คอลัมน์นี้จะใช้ต่อในโมดูล M3
...
### โมดูล M3 - สรุปข้อมูลด้วยสถิติพื้นฐาน (35 นาที, 4 คะแนน)
...
### โมดูล M4 - นับตามเงื่อนไข ตรรกะ และการค้นหา (35 นาที, 5 คะแนน)
...
### โมดูล M5 - การสร้างกราฟ (20 นาที, 2 คะแนน)
...
|---|---|---|
| Pre-lab quiz | 2 | คะแนนจาก Google Form ตรวจอัตโนมัติ |
| M1 ฝึกพื้นฐาน | 2 | ทำแบบฝึกครบ 6 ข้อและใช้สูตรจริง |
| M2 ฟังก์ชันข้อความและการทำความสะอาด | 5 | สูตรคอลัมน์ F ถึง T ถูกต้องและลากครบทุกแถว |
| M3 สรุปข้อมูลด้วยสถิติพื้นฐาน | 4 | ใช้ครบ 7 ฟังก์ชัน และตีความ MIN/MAX ได้ |
...
|---|---|
| ทำไมทรงลูกแพร์จึงเป็นลักษณะด้อย และลำดับดีเอ็นเอบอกอะไรเราได้ | ปฏิบัติการ 12B - การวิเคราะห์ลำดับดีเอ็นเอด้วยสเปรดชีต |
| ค่าที่สังเกตได้ต่างจากค่าคาดหมายมากพอที่จะมีความหมายหรือไม่ | ปฏิบัติการ 13 - Basic Statistical Analysis (การทดสอบไคสแควร์) |
