...
1. สร้างเวกเตอร์ที่ประกอบด้วยน้ำหนัก (22.5, 19.8, 25.3, 21.0, 23.7, 18.4, 26.1, 20.6, 24.2, 22.9 เป็นกรัม) ของตัวอย่างหนูห้องปฏิบัติการ 10 ตัว
2. คำนวณค่าเฉลี่ย มัธยฐาน ส่วนเบี่ยงเบนมาตรฐาน และช่วงของน้ำหนักเหล่านี้
3. สร้างฮิสโตแกรมของน้ำหนักหนูและอธิบายการกระจาย
4. โหลดข้อมูลตาราง Practice_Exercises_plant.csv เข้าสู่งโปรแกรม R
5. คำนวณค่าเฉลี่ยของการวัดของคุณจำแนกตาม Species และ Treatment โดยใช้ฟังก์ชัน R ที่เหมาะสม
6. สร้างกล่องพล็อตเปรียบเทียบการวัดหนึ่งในการวัดของคุณระหว่าง Treatment และตีความผลลัพธ์
