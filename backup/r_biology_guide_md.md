...
experiment[experiment$Leaf_Count > 8, ]               # Rows where Leaf Count > 8

# Calculate growth and create the new column in the dataframe
...
4. Load Practice_Exercises_plant.csv into R
